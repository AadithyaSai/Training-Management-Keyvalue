    ...
    >
      ...
      <div className="flex flex-col gap-1 mt-2">
        ...
        {heading == "session" ? (
          ...
          <>
            <p className="text-sm mt-1">
              Start date : {dayjs(item.startDate).format("DD/MM/YYYY")}
            </p>
            <p className="text-sm mt-1">
              End date : {dayjs(item.endDate).format("DD/MM/YYYY")}
            </p>
          </>
        )}
        {item.trainer && (
        ...
        {item.totalSessions !== undefined && (
          <p className="text-sm mt-1">Total sessions : {item.totalSessions}</p>
        )}
          ...
          <div className="flex items-center space-x-3">
            ...
            {heading == "Sessions" && (
              ...
              >
                ...
                <option className="bg-itemColor" value={EventStatusType.DRAFT}>
                  Draft
                </option>
                <option
                  className="bg-itemColor"
