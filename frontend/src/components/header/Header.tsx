...
const Header: React.FC<HeaderProps> = ({ title = "Title", endAdornments }) => {
    return (
        <div
            className={`flex items-center justify-between w-full py-4 px-10 bg-cardColor h-headerHeight fixed top-0 left-0 right-0 text-white z-50 shadow-bgColor shadow-md`}
        >
